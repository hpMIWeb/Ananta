...
const ClientTimeSheet = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (remark: string) => <div className="scrollbar-td">{remark}</div>,
    },
    {
      title: "Work Area",
      dataIndex: "work_area",
  ...
  const tabContent: TabsProps["items"] = [
    ...
    },
    {
      key: "3",
      label: (
        <Link to="/client-time-sheet" style={{ textDecoration: "none" }}>
  ...
  return (
    <div className={styles.timeSheetPageWrapper}>
      <div
        className={classNames("card-header d-flex", styles.timeSheetPageHeader)}
      >
        <div
          ...
          <div className="summery">
            <ul className="summery1">
              ...
              <li className="w100 employeeLi">
                ...
                <p className="employeeSummaryLable w100">Time Period</p>
              </li>
              <Divider type="vertical" className="divider" />
              <li className="w100 employeeLi">
              ...
              <li className="w100 employeeLi">
                ...
                <p className="employeeSummaryLable">Total Budget Time</p>
              </li>
              <Divider type="vertical" className="divider" />
              <li className="w100 employeeLi">
                <p className="employeeSummaryData">
                ...
                <p className="employeeSummaryLable">Total Actual Time</p>
              </li>
              <Divider type="vertical" className="divider" />
              <li className="w100 employeeLi">
                <p className="employeeSummaryData">
                ...
                <p className="employeeSummaryLable">Total Difference</p>
              </li>
            </ul>
          </div>
          <div>
