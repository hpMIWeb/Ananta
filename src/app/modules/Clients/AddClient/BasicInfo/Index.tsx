          ...
          <div className="col-12 col-md-9 col-lg-9">
            ...
            <div className={classNames("row", styles.formFieldWrapper)}>
              ...
              >
                <div>
                  <label className="form-label">
                    Firm Name<sup className="text-danger fs--1">*</sup>
                  </label>
                  <Form.Item
                    name="firmName"
                    rules={[
              ...
              >
                <div>
                  <label className="form-label">
                    Indusrty type<sup className="text-danger fs--1">*</sup>
                  </label>
                  <Form.Item
                    name="industryType"
                    rules={[
                      {
                        required: true,
                        message: "Please Enter your Indusrty type!",
                      },
                    ]}
                  >
                    <Input
              ...
              >
                <div>
                  <label className="form-label">
                    Line of Business<sup className="text-danger fs--1">*</sup>
                  </label>
                  <Form.Item
                    name="lineOfBusiness"
                    rules={[
                      {
                        required: true,
                        message: "Please Enter your Line of Business!",
                      },
                    ]}
                  >
                    <Input
