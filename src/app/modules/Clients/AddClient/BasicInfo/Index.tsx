            ...
            <div className={classNames("row", styles.formFieldWrapper)}>
              ...
              >
                <div>
                  ...
                  >
                    <Select defaultValue="Partnership" options={firmTypes} />
                  </Form.Item>
                </div>
              </div>
              ...
              {registrationValidClientType.indexOf(clientType) !== -1 && ( // Check if clientType is "CA"
                <div
                  className={classNames(
                    "col-12 col-md-4 col-lg-4",
                    styles.fieldPadding8
        ...
        <div className={classNames("row", styles.formFieldWrapper)}>
          ...
          >
            <div>
              ...
              <Form.Item name="city" className="customAddFormSelectOptions">
                <Select
