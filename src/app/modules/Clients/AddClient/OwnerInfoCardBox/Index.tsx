      ...
      <div className="col-12 col-md-9 col-lg-9">
        <div className={classNames("row", styles.formFieldWrapper)}>
          ...
          >
            <div>
              <label style={{ marginBottom: 5 }} className="form-label">
                First Name<sup className="text-danger fs--1">*</sup>
              </label>
              <Form.Item
                {...field}
          ...
          >
            <div>
              <label style={{ marginBottom: 5 }} className="form-label">
                Last Name<sup className="text-danger fs--1">*</sup>
              </label>
              <Form.Item
                {...field}
          ...
          >
            <div>
              <label style={{ marginBottom: 5 }} className="form-label">
                Select Gender<sup className="text-danger fs--1">*</sup>
              </label>
              <Form.Item
                {...field}
          ...
          >
            <div>
              <label style={{ marginBottom: 5 }} className="form-label">
                Date of Birth<sup className="text-danger fs--1">*</sup>
              </label>
              <Form.Item
                {...field}
          ...
          >
            <div>
              <label style={{ marginBottom: 5 }} className="form-label">
                Email Id<sup className="text-danger fs--1">*</sup>
              </label>
              <Form.Item
                {...field}
            ...
            <div>
              ...
              >
                <Input
                  ...
                  placeholder={canDelete ? "Alternate Mobile" : "Alt Mobile"}
                  className="customAddFormInputText"
                />
              </Form.Item>
            </div>
            ...
            <div>
              ...
              >
                <Input
                  ...
                  placeholder={canDelete ? "Alternate Mobile" : "Referred By"}
                  className="customAddFormInputText"
                />
              </Form.Item>
            </div>
