        ...
        <div className={styles.branchFieldWrapper}>
          <div className={classNames("row", styles.formFieldWrapper)}>
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  Bank Name<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  Branch Name<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  Account No<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  Account Type<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
                ...
                >
                  <Select
                    ...
                    options={[
                      ...
                      { label: "Over Draft", value: "Over Draft" },
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  IFCS Code<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your IFCS Code!",
                    },
                    {
                      len: 11, // IFCS Code length should be 11 characters
                      message: "IFCS Code must be 11 characters long!",
                    },
                  ]}
                >
                  <Input
            ...
            >
              <div>
                <label style={{ marginBottom: 7 }} className="custom-label">
                  MIRC Code<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your MIRC Code!",
                    },
                  ]}
                >
                  <Input
