    ...
    >
      <div style={{ marginTop: 2 }}>
        <div className={classNames("row mb-3", styles.paymentFormRow)}>
          ...
          <div
            className={classNames("col-12 col-sm-6 col-md-4", styles.padding8)}
          >
        ...
        <div className={classNames("row mb-3", styles.paymentFormRow)}>
          <div className={classNames("col-auto", styles.padding8)}>
            <label style={{ minWidth: 120 }} className="form-label">
              Payment Terms<sup className="text-danger fs--1">*</sup>
            </label>
          </div>
          <div
            className={classNames("col-12 col-sm-6 col-md-4", styles.padding8)}
        ...
        {paymentForm.paymentTerms === "Credit" && (
          <div className={classNames("row mb-3", styles.paymentFormRow)}>
            <div className={classNames("col-auto", styles.padding8)}>
              <label style={{ minWidth: 120 }} className="form-label">
                Credit Period<sup className="text-danger fs--1">*</sup>
              </label>
            </div>
            <div
            ...
            >
              <div className="row">
                ...
                <div className="col-auto">
                  <div style={{ minWidth: 130 }} className="mb-3">
                    <Form.Item
            ...
            {paymentForm.creditPeriodTime && paymentForm.creditPeriodType && (
              <div className={classNames("col", styles.padding8)}>
                <div className="d-flex">
                  <p className="semiBold me-3">Payment Due Date</p>
                  <p>{futureDate}</p>
                </div>
              </div>
            )}
        ...
        <div className={classNames("row mb-3", styles.paymentFormRow)}>
          <div className={classNames("col-auto", styles.padding8)}>
            <label style={{ minWidth: 120 }} className="form-label">
              Payment Mode<sup className="text-danger fs--1">*</sup>
            </label>
          </div>
          <div
            className={classNames("col-12 col-sm-6 col-md-4", styles.padding8)}
        ...
        {paymentRowData.map((payment, index) => (
          <React.Fragment key={index}>
            <PaymentFieldRow />
            {payment.type === "new" && <hr style={{ marginTop: 0 }} />}
            {payment.type === "new" && (
