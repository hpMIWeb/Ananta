...
const AssignClient = ({ onChange, setEmployeeInfo }) => {
  const getClients = useSelector((state) => state.getClients.data);
  const [addedClientList, setAddedClientList] = useState([]);
  ...
  const onAddedClientList = (id) => {
    setAddedClientList([...addedClientList, selectedClientId]);
    setSelectedClientId("")
  };

  const onRemoveClientList = (id) => {
    setAddedClientList(addedClientList.filter((a) => a !== selectedClientId));
    setSelectedClientId("")
  };
      ...
      <div className="row">
        <AssignClientBox
          ...
          clientList={getClients.filter(
            (a) => !addedClientList.includes(a._id)
          )}
        ...
        <AssignClientBox
          ...
          selectedClientId={selectedClientId}
          setSelectedClientId={setSelectedClientId}
          clientList={getClients.filter((a) =>
