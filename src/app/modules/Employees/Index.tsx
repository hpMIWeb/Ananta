                ...
                descComponent: (
                    <>
                        ...
                        <p className="semiBold">
                            {" "}
                            {cardData.organizationDetails[0]?.department
            ...
            },
            {
                ...
                descComponent: (
                    <>
                        ...
                        <p className="semiBold">
                            {" "}
                            {cardData.organizationDetails[0]?.designation
                                ?.name || "Designation Not Available"}
                        </p>
                    </>
                ),
            },
                    ...
                    <>
                        {cardData.subProfile.length > 0 ? (
                            ...
                            <div>
                                ...
                                <p className="semiBold">
                                    {" "}
                                    {cardData.organizationDetails[0]?.role
