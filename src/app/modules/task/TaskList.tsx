...
const TaskList = () => {
  ...
  const colInfo = [
    ...
    },
    {
      ...
      render: (record: any) => (
        <>
          <span className="clientDiv">{record.client[0].client_name}</span>
        </>
      ),
    },
    {
  ...
  return (
    <div className={styles.taskPageWrapper}>
      <div className={classNames("card-header d-flex", styles.taskPageHeader)}>
        <div
      ...
      <div className={styles.taskBottomWrapper}>
        <div className="task-list-header">
          ...
          <div
            className={classNames("ms-auto z-index-1", styles.taskListAdd)}
          ></div>
        </div>
        <div>
          <div
