...
const SubscriptionTabAddClient = ({ onChange, setFormValue }: any) => {
    ...
    return [
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Time Period</p>
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Transactions</p>
        ...
        descComponent: (
          <>
            ...
            <ul className="ps-3 mt-1 semiBold mb-1 feature-description-list">
              <li>CA Employee & OwnerLogin - {details.no_of_client}</li>{" "}
              <li>
                ClientOwner & Employee Login - {details.no_of_client_login}
              </li>{" "}
              <li>Client Vendor Login - {details.no_of_employee}</li>{" "}
            </ul>
          </>
        ),
      },
  ...
  const handleAddonChange = (
    ...
    const updatedAddons = subscriptionAddons.map((addon: any, i: number) => {
      if (i === index) {
        return {
          ...addon,
          [field]: value,
  ...
  useEffect(() => {
    if (selectedCoupon) {
      ...
      if (selectedCoupon.type === "Percentage") {
        const pctValue =
          (selectedSubscriptionPlan.price * selectedCoupon.ammount) / 100;
  ...
  return (
    ...
    >
        ...
        <div className={classNames("row", styles.subscriptionFormBox)}>
          ...
          >
            <div className="row g-3">
              <div
                className={classNames("col-6", styles.subscriptionFormColumn)}
              >
                <div className="mb-2">
                  <label
                    className={classNames(
              ...
              <div className="row">
                ...
                >
                  ...
                  <div className="d-flex align-items-center mb-3">
                    ...
                    >
                      {monthAdded && monthAdded.format("YYYY-MM-DD")}
                    </p>
                  </div>
                </div>
                <div
            ...
            {isPlanSelected && (
              <div className={styles.addCaPlanBorder}>
                <div className="mt-2 mb-3">
                  ...
                  <p className="text-center mb-0">subscription</p>
                </div>
                <hr className={styles.subscriptionLine} />
                <div className="mb-3 mt-3">
                  ...
                  >
                    {cardDesc(selectedSubscriptionPlan).map((card, index) => (
      ...
      >
        <Row gutter={[8, 8]} className="form-row" style={{ marginTop: "0" }}>
          <Col
            xs={{ span: 24 }}
            sm={{ span: 24 }}
            md={{ span: 24 }}
