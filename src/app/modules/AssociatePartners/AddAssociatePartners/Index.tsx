        ...
        <div className="row">
          {roleType === "client" && (
            <div className={classNames("col-12 col-md-4 col-lg-4")}>
              <div className="mb-3">
                <label className={classNames("form-label", styles.rowTitle)}>
                  Partners Category
                  ...
                  <Select
                    ...
                    onChange={(value: any) => {
                      ...
                      if (value === "sales_partner") {
                        setPartnerTypeLabel("Sales Partner");
                      } else {
                        setPartnerTypeLabel("Service Partner");
                      }
                    }}
                  />
                </Form.Item>
          ...
          <div className={classNames("col-12 col-md-4 col-lg-4")}>
            <div className="mb-3">
              ...
              >
                <Select
                  options={partnerTypeOption.map((partnerType: any) => ({
                    label: partnerType?.label,
                    value: partnerType?.value,
                  }))}
                  placeholder="Select Type"
                  onChange={(value: any) => setPartnerType(value)}
                />
              </Form.Item>
            </div>
          </div>
