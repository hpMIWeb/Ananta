...
const BranchInfoCard = ({
  ...
  const [citiesListData, setCityListData] = useState<any>([]);
  ...
  useEffect(() => {
    ...
    if (branchDetailsFormValue?.branchCountry) {
      const selectedCountryId = countriesListData.find(
        (c: any) => c.countryName === branchDetailsFormValue?.branchCountry
      ).geonameId;
          ...
          <div className={classNames("row", styles.formFieldWrapper)}>
            ...
            >
              <div>
                ...
                >
                  Address<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
            ...
            >
              <div>
                ...
                >
                  Pin Code<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
            ...
            >
              <div className="mb-3">
                ...
                >
                  Country<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
                ...
                >
                  <Select
                    ...
                    options={countriesListData.map((country: any) => ({
            ...
            >
              <div className="mb-3">
                ...
                >
                  State<sup className="text-danger fs--1">*</sup>
                </label>
                <Form.Item
                  {...field}
                ...
                >
                  <Select
                    ...
                    options={statesListData.map((state: any) => ({
                      value: state.name,
                      label: state.name,
                    }))}
                  />
              ...
              <div className="mb-3">
                ...
                >
                  <Select
                    ...
                    options={citiesListData.map((city: any) => ({
                      value: city.name,
                      label: city.name,
                    }))}
                  />
            ...
            >
              <div className="mb-3">
                ...
                <Form.Item
                  ...
                  fieldKey={[field.fieldKey, "seperateTallyData"]}
                  className="customAddFormSelectOptions"
                  rules={[
                    {
                      required: true,
                      message: "Please Select Separate Tally Data!",
                    },
                  ]}
                >
                  <Select
