...
const SubProfile = ({ selectedAssociatePartnerData }: any) => {
    ...
    const showModal = () => {
        ...
        form.setFieldsValue({ subProfileId: getAutoGeneratedId("A") });
        setOpen(true);
    };

    const [selectedSubProfileId, setSelectedSubProfileId] =
        useState<String>("");
    ...
    useEffect(() => {
        setSubProfileList(selectedAssociatePartnerData.subProfile);
    ...
    }, [departmentList, designationList, roleList, teamList]);
        ...
        if (changedSubProfile) {
            ...
            dispatch(
                createEmployeeReducersApi({
                    ...
                    employeeId: selectedAssociatePartnerData?._id,
                })
            );
        }
    };
    ...
    const handleProfileClick = (id: string) => {
        ...
        if (changedSubProfile) {
            showModal();
            setSelectedSubProfileId(changedSubProfile.subProfileId);
            form.setFieldsValue({
                subProfileId: changedSubProfile.subProfileId,
                firstName: changedSubProfile.firstName,
                middleName: changedSubProfile.middleName,
                lastName: changedSubProfile.lastName,
                gender: changedSubProfile.gender,
                bloodGroup: changedSubProfile.bloodGroup,
                email: changedSubProfile.email,
                mobile: changedSubProfile.mobile,
                department: changedSubProfile.department,
                team: changedSubProfile.team,
                designation: changedSubProfile.designation,
                role: changedSubProfile.role,
            });
        }
    };
    ...
    const onFinish = (value: any) => {
        ...
        if (selectedSubProfileId != "") {
            // edit sub profile changes
            const changedSubProfile = newSubProfile.find(
                (s: any) => s.subProfileId === selectedSubProfileId
            );
            const updateSubProfileList = newSubProfile.filter(
                (s: any) => s.subProfileId !== selectedSubProfileId
            );
            updateSubProfileList.push(value);
            dispatch(
            ...
            // all insert code for sub profile
            dispatch(
                createAssociatePartnerReducersApi({
                                                ...
                                                rules={[
                                                    {
                                                        required: true,
                                                        message:
                                                            "Please Enter your Sub Profile ID!",
                                                    },
                                                ]}
                                            >
                                                <Input
