...
const AddCompliance = () => {
  ...
  const [subCompliance, setSubCompliance] = useState<IInsertSubCompliance[]>();
  ...
  const handleAddCompliance = () => {
    ...
    if (!validateTaskData.status) {
      ...
      if (subCompliance && subCompliance.length > 0) {
        ...
        newDetails = subCompliance.filter((item: IInsertSubCompliance) => {
      ...
      <div className={classNames("card mb-3", styles.addPromoCodeCardWrapper)}>
        ...
        <div className={styles.addClientDetailBox}>
          ...
          >
                    ...
                    ({ getFieldValue }) => ({
                      validator(_, value) {
                        ...
                        return Promise.reject(
                          new Error("Start date should be before the due date.")
                        );
                      },
                    }),
                  ]}
            ...
            <div className="row">
              <div className={classNames("col-12 col-md-8 col-lg-8")}>
                <Form.Item
                  className="customAddClientSelectOptions"
                  name="title"
                  rules={[
