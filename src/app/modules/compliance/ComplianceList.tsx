        ...
        <Row gutter={[8, 8]} className="form-row" style={{ marginTop: "10px" }}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }}>
            <Select
              ...
              showSearch
              placeholder={
                reportType === "compliance_wise" ? "Client" : "Compliance"
              }
              options={reportType === "compliance_wise" ? clientOpts : []}
              className="w100 border-bottom"
              bordered={false}
            />
          </Col>
        ...
        <Row gutter={[8, 8]} className="form-row" style={{ marginTop: "10px" }}>
          ...
          <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }}>
            <Select
              allowClear
              showSearch
              placeholder={reportType === "Client" ? "Client" : "Compliance"}
  ...
  return (
    <>
      <div className={styles.taskPageWrapper}>
        <div
          className={classNames("card-header d-flex", styles.taskPageHeader)}
        >
          <div
