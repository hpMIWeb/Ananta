  ...
  const cardDesc = (cardDetails: any) => {
    ...
    return [
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Maximum Discount</p>
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Minimum Order Value</p>
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Use of code</p>
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Use per user</p>
            <p className="semiBold">
      ...
      },
      {
        ...
        descComponent: (
          <>
            <p className="mb-0 fs--1 description-label">Time Utilized</p>
            <p className="semiBold">
