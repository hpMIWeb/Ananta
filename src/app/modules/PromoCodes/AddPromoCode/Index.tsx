      ...
      >
        <div className="d-flex align-items-center w-100">
          <div className="me-auto">
            ...
            >
              {!promocodeId ? "Add Promo Code" : "Edit Promo Code"}
            </h5>
          </div>
        </div>
        <div
        ...
        >
          <div className="formFieldRowWrapper formAddPromoWrapper">
            <div className="col-auto formLabelWrapper">
              <label className="form-label">Coupon Code Name</label>
            </div>
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Coupon Code Name!",
                  },
                ]}
              >
                <Input
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Coupon Description!",
                  },
                ]}
              >
                <Input
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Coupon Type!",
                  },
                ]}
              >
                <Select
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Discount Amount!",
                  },
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Start Date & Time!",
                  },
                ]}
              >
                <DatePicker
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your End Date & Time!",
                  },
                ]}
              >
                <DatePicker
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your User Category!",
                  },
                ]}
              >
                <Select
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Life of Code!",
                  },
                ]}
              >
                <Input
            ...
            <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Use per User!",
                  },
                ]}
              >
                <Input
            ...
            <div className="col-12 col-sm-6 col-md-8 formInputWrapper">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please Enter your Terms & Conditions!",
                  },
                ]}
              >
