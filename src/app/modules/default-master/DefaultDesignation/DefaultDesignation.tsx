...
const DefaultDesignation = () => {
    ...
    const [addDesignation, setAddDesignation] =
        useState<IAddDefaultDesignation>({} as IAddDefaultDesignation);
    ...
    const deleteClickHandler = (designationId: string) => {
        // Delete from  DB
        setLoading(true); // Set loading state to true
        api.deleteDefaultDesignation(designationId)
            .then((resp: any) => {
