...
import styles from "./DefaultChecklist.module.scss";
...
const DefaultChecklist = () => {
  ...
  const [selectedChecklist, setSelectedChecklist] = useState<IDefaultCheckList>(
    {} as IDefaultCheckList
  );
  ...
  const deleteClickHandler = (checklistId: string) => {
    // Delete from  DB
    api
      .deleteDefaultChecklist(checklistId)
      .then((resp: any) => {
        ...
        try {
          ...
          const apiCall =
            modalMode === "add"
              ...
              : api.updateDefaultChecklist(addChecklist, selectedChecklist._id);
  ...
  const viewClickHandler = (checklist: IDefaultCheckList) => {
    setSelectedChecklist(checklist);
