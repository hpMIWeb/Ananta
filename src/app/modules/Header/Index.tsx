          ...
          <div className={styles.demoLogoVertical}>
            <div className="d-flex align-items-center">
              <div className={styles.toggleIconWrapper}>
                <Tooltip placement="right" title="Toggle Navigation">
                  <button
                    ...
                    className={classNames(styles.navbarToggleMinus, {
                      [styles.navbarToggleMinusCollapsed]: collapsed,
                    })}
              ...
              <Link className="navbar-brand" to="/">
                ...
                >
                  <img className="me-2" src={falconIcon} alt="" width="40" />
                  <span className={styles.navbarLogoTitle}>NV</span>
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
            ...
            <div className="theme-control-toggle fa-icon-wait px-2">
              ...
              >
                ...
                >
                  <Icon
                    name={theme === "light" ? "lightTheme" : "darkTheme"}
                    height={16}
                    width={16}
                  />
                </Button>
