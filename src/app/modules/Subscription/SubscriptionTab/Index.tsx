      ...
      },
      {
        ...
        descComponent: (
          <>
            ...
            <p className="mb-0 fs--1 semiBold">Rs. {cardInfo.price}</p>
          </>
        ),
      },
      {
        ...
        descComponent: (
          <>
            ...
            <ul className="ps-3 mt-1 fw-semi-bold mb-1 feature-description-list">
              ...
              <li>Client Office Users - {cardInfo.no_of_employee}</li>
              <li>Client Vendors Users - {cardInfo.no_of_client_login}</li>
            </ul>
          </>
        ),
      },
