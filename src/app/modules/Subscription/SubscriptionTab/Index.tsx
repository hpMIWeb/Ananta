  ...
  const generateFeatureLists = (features: any) => {
    ...
    for (let i = 0; i < features.length; i += 3) {
      const featureListUI = (
        ...
        >
          {features.slice(i, i + 3).map((feature: any, index: any) => (
    ...
    if (roleType === "superadmin") {
      ...
      return [
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Validity</p>
          ...
          descComponent: (
            <>
              ...
              <p className="mb-0 fs--1 semiBold">
                Rs. {displayNumberInCurrencyFormate(cardInfo.price)}
              </p>
            </>
          ),
        },
        {
          ...
          descComponent: (
            <>
              ...
              <p className="semiBold">{cardInfo.no_of_transactions}</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Subscribers</p>
          ...
          descComponent: (
            <>
              ...
              <ul className="ps-3 mt-1 fw-semi-bold mb-1 feature-description-list">
                <li>
                  CA Office Users -{" "}
                  {cardInfo.no_of_users && cardInfo.no_of_users.office_users
                ...
                <li>
                  ...
                  {cardInfo.no_of_users && cardInfo.no_of_users.client_vendor
      ...
      return [
        ...
        },
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Validity</p>
              <p className="semiBold">
                {cardInfo.period} {capitalize(cardInfo.period_type)}
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Branches</p>
              <p className="semiBold">
        ...
        },
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Turnover Limit</p>
              <p className="semiBold">
                {displayNumberInCurrencyFormate(cardInfo.turnover)}
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          descComponent: (
            <>
              <p className="mb-0 fs--1 description-label">Transaction</p>
              <ul className="ps-3 mt-1 fw-semi-bold mb-1 feature-description-list">
                <li>
                  Sale & Purchase-{" "}
                ...
                <li>
                  Contras -{" "}
                  {cardInfo.transactions && cardInfo.transactions.contras
                    ? cardInfo.transactions.contras
                    : 0}
                </li>{" "}
                <li>
                  Journals -{" "}
                  {cardInfo.transactions && cardInfo.transactions.journals
                    ? cardInfo.transactions.journals
                    : 0}
                </li>
                <li>
                  Stock Journals -{" "}
                  {cardInfo.transactions && cardInfo.transactions.stock_journals
