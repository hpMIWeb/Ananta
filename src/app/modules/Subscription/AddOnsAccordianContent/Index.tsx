    ...
    return [
      {
        ...
        descComponent: (
          <>
            <p className={classNames("mb-0 fs--1", styles.descLabel)}>Price</p>
            <p className={styles.semiBold}>{addOnsDetail.price}/-</p>
          </>
        ),
      },
      {
        ...
        descComponent: (
          <>
            <p className={classNames("mb-0 fs--1", styles.descLabel)}>
              Validity
            </p>
            <p className={styles.semiBold}>
              {addOnsDetail.time_period}{" "}
              {addOnsDetail.time_period_type === "MONTH" ? "Months" : "Days"}
            </p>
          </>
        ),
      },
      {
        ...
        descComponent: (
          <>
            ...
            <p className={styles.semiBold}>{addOnsDetail.storage_size} GB</p>
          </>
        ),
      },
      {
