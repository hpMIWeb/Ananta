      ...
      >
        <div className="d-flex align-items-center w-100">
          <div className="me-auto">
            ...
            >
              {!subscriptionId ? "Add Subscription" : "Edit Subscription"}
            </h5>
          </div>
        </div>
        <div
      ...
      <div className={styles.customAddFormWrapper}>
        ...
        {!(subscriptionCardListLoading && subscriptionId) && (
          ...
          >
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your Storage Space!",
                    },
                  ]}
                >
                  <Input
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your CA Office Users Number!",
                    },
                  ]}
                >
                  <Input
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your Client Office Users Number!",
                    },
                  ]}
                >
                  <Input
                    className="customAddFormInputText"
                    suffix={
                      <div className="inputSuffix">Client Office Users</div>
                    }
                  />
                </Form.Item>
              </div>
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your Client Vendor Users Number!",
                    },
                  ]}
                >
                  <Input
            ...
            <div className="formFieldRowWrapper">
              <div className="col-auto formLabelWrapper">
                <label className="form-label">Transaction Credits</label>
              </div>
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please Enter your Transaction Credits!",
                    },
                  ]}
                >
                  <Input
            ...
            <div className="formFieldRowWrapper">
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <div className={styles.featureCheckBoxWrapper}>
                  {featureList.map((task: any, index: any) => (
                    <div key={index}>
                      <Switch
                        size="small"
                        className="smallCheckBox"
                        // checked={
                        //   featureState[task.feature] ?? task.defaultState
                        // }
                        onChange={() => handleFeatureToggle(task.feature)}
                      />
                      <label className={styles.featureCheckBoxLabel}>
                        {
                          task.feature
              ...
              <div className="col-12 col-sm-6 col-md-4 formInputWrapper">
                <div className="position-relative">
                  <span className={styles.rupeesInputIcon}>
                    <Icon width={12} height={12} name="IndianRupee" />
                  </span>
                  <Form.Item
                    name="price"
                    rules={[
