...
import { setLocalstorage, getLocalStorage } from "../../app/utilities/utility";

import api from "../../app/utilities/apiServices";
import { ToastContainer, toast } from "react-toastify";
import { IComment } from "../../app/utilities/globalInterfaces";
      ...
      return (
        ...
        >
          <div className="commentcnt">
            ...
            >
              ...
              <strong className="float-end text-muted comment-date">
                ...
                <span>
                  <FontAwesomeIcon
                    icon={
                      isEditComment && commentItem._id === editCommentItem._id
                        ? faClose
                        : faEdit
                    }
                    className="btn-at"
                ...
                <span>
                  <Popconfirm
                    ...
                    onConfirm={() =>
                      deleteCommentHandler(commentItem._id, props.parentId)
                    }
                  >
                    <FontAwesomeIcon
                      icon={faTrash}
            ...
            >
              {parse(commentItem.comment.replace(/\n/g, "<br />"))}
            </p>
            <div
              style={{
                display:
      ...
      <div className="addcmtform">
        ...
        <div className="addcmtbtn">
          <FontAwesomeIcon
            ...
            title="Upload"
          />
          <FontAwesomeIcon icon={faAt} className="btn-at" title="Add Person" />
