    ...
    const columns = [
            ...
            children: [
                {
                    ...
                    render: (no_of_users: any) => (
                        <span>{no_of_users.employee_ca}</span>
                    ),
                },
                {
                    ...
                    width: 80, // Set the desired width (adjust as needed)
                    render: (no_of_users: any) => (
                        <span>{no_of_users.employee_client}</span>
                    ),
                },
                {
                    ...
                    width: 80, // Set the desired width (adjust as needed)
                    render: (no_of_users: any) => (
                        <span>{no_of_users.client_vendor}</span>
                    ),
                },
            ],
        },
        ...
        },
        {
            ...
            render: (subscriptionHistoryData: any) => (
                <span>
                    {subscriptionHistoryData.period}{" "}
                    {capitalize(subscriptionHistoryData.period_type)}
                </span>
            ),
        },
        {
        ...
        },
        {
            ...
            className: "center-align-cell",
            render: (displayOnPortal: boolean) =>
                displayOnPortal ? "Yes" : "No",
        },
        {
            title: "Status",
            dataIndex: "status",
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    className: "center-align-cell",
                    render: (featureData: any) => {
                        const isTemplateCustomizationEnabled =
                            featureData.Tamplate_Customization_for_import;
                        const icon = isTemplateCustomizationEnabled
                            ? faCheck
                            : faTimes;
                        const color = isTemplateCustomizationEnabled
                            ? "green"
                            : "red";
                        return (
                            <span style={{ color }}>
